...
<section class="pages-hero package-det">
      <div class="home-page-slider">
        <img
          src="<?php bloginfo('template_directory');?>/images//goldzanzibar.jpeg"
          alt="goldzanzibar"
          class="home-page-img"
        />
        <img
      ...
      <div class="container flex flex-cl">
        <h1>gold zanzibar and tembo hotel</h1>
        <span class="days">4 NIGHTS / 5 DAYS</span>
    ...
    <section class="details" id="details">
      ...
      <div class="container">
        <h2>ITINERARY</h2>
        <p class="det-top-p">
          Enjoy an exceptional 4-night, 5-day Zanzibar package with
          accommodation at the beautiful Gold Zanzibar Resort at Kendwa Beach
          and Tembo House Hotel at the Stone Town, offering you the finest
          hospitality while you explore the pristine white sand beaches,
          turquoise blue ocean waters and the glowing green of the sea-side
          vegetation of the islands. This tour starts with pick-up and ends with
          drop-off at the Abeid Amani Karume International Airport. <br />
        ...
        <div class="itinerary">
          <div class="itinerary-content">
            <div class="way">
              ...
              <h3>
                Abeid Amani Karume International Airport - Gold Zanzibar Resort
              </h3>
              <p>
                Your driver reports at Abeid Amani Karume International Airport
                for pick-up and road transfer to Gold Zanzibar Resort. Enjoy the
                drive across the beautiful island on your way to the resort.
                Check-in at the resort and for an overnight stay.
              </p>
              <p>
                The Gold Zanzibar Resort offers you the experience of staying in
                a tropical paradise on the tideless white sands of Kendwa Beach
                in Zanzibar. Situated on Kendwa Beach, this resort has a pool
                and a beach restaurant that allows you to enjoy the breathtaking
                views of the golden sunsets of Zanzibar.
              </p>
              <p>
                Road Transfer From Zanzibar Airport To Gold Zanzibar Resort:
                <br />
                <span class="travel-time">1 hour 20 minutes</span> <br />
                Distance: <span class="travel-time">55 km</span> <br />
              </p>
            </div>
            <div class="way">
              ...
              <p>
                ...
                the island. Feel the refreshing breeze as you relax on your
                beachfront lounger or hammock strung between the trees along the
                shores.
              </p>
              <p>
                Kendwa Beach is a paradise for fans of outdoor activities who
                love snorkeling, diving, and surfing. The coral reef spread
                around the beach attracts diving enthusiasts from all around the
                world. The beach is the home of sea urchins, squid, crabs,
                stingrays, whale sharks, dolphins, and butterfly fish, which are
                visible in crystal clear water.
              </p>
              <p>
            ...
            <div class="way">
              ...
              <h3>Gold Zanzibar Resort - Stone Town</h3>
              <p>
                Your driver reports to the Gold Zanzibar Hotel for a road
                transfer to Stone Town. On the route, you will visit the spice
                plantations for a tour that will awaken your senses. On the
                spice tour, you can pick, smell and savor the spices and fruits
                you have probably never seen on the supermarket shelf. You can
                observe closely how local farmers produce some of the world’s
                most exotic spices and fruits like cloves, star fruit, lemon
                grass, mangosteen, lipstick trees and many more, depending on
                the season.
              </p>
              <p>
              ...
              <p>
                After your Stone Town tour, stay overnight at the Tembo Hotel.
              </p>
            ...
            <div class="way">
              ...
              <h3>Tembo Hotel - Abeid Amani Karume International Airport</h3>
              <p>
                Have breakfast and check out from the Tembo Hotel. Your driver
                reports at the hotel for a road transfer to the Abeid Amani
                Karume International Airport on time for your departure flight.
              </p>
              <h4>End of Trip</h4>
              <h4>Price Starting From:</h4>
              <p>$2,670 USD for 2 people</p>
            </div>
          </div>
        ...
        <div class="det-down">
          <div class="inclusion">
            ...
            <ul>
              <li>
                3 nights’ accommodation at Gold Zanzibar Beach Resort in deluxe
                ocean view rooms on full-board basis and 1 night at Tembo Hotel
                in prime double rooms on bed-and-breakfast based on 2 people
                sharing
              </li>
          ...
          <div class="inclusion">
            <h3>EXCLUSIONS</h3>
            <ul>
              <li>International and local air tickets</li>
              <li>Visa fees</li>
              <li>Tips</li>
              <li>Lunch & dinner</li>
            </ul>
