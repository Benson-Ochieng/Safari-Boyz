...
<section class="pages-hero package-det">
      <div class="home-page-slider">
        ...
        />
        <img
          src="<?php bloginfo('template_directory');?>/images//royalzanzibar.jpeg"
          alt="royalzanzibar"
          class="home-page-img"
        />
        <img
      ...
      <div class="container flex flex-cl">
        <h1>royal zanzibar and tembo hotel</h1>
    ...
    <section class="details" id="details">
      ...
      <div class="container">
        ...
        <p class="det-top-p">
          ...
          accommodation at the beautiful Royal Zanzibar Beach Resort and Tembo
          House Hotel, offering you the finest hospitality while you explore the
          dazzling sands with turquoise waters of the Nungwi Beach and the
          glowing green seaside vegetation of the islands. This tour starts with
          pickup and ends with drop-off at the Abeid Amani Karume International
          Airport. The typical tour itinerary is listed below:
        </p>
        <div class="itinerary">
          <div class="itinerary-content">
            <div class="way">
              ...
              <h3>
                Abeid Amani Karume International Airport - Royal Zanzibar Beach
                Resort
              </h3>
              <p>
                Your driver reports at Abeid Amani Karume International Airport
                for pick-up and road transfer to Royal Zanzibar Beach Resort.
                Enjoy the drive across the beautiful island on your way to the
                resort. Check-in at the resort for an overnight stay.
              </p>
              <p>
                The Royal Zanzibar Beach Resort is located at Nungwi Beach, on
                the stunning tropical island of Zanzibar, offering you the most
                amazing stay and the experience of a vacation of a lifetime by
                the beautiful warm waters.
              </p>
              <p>
                Road Transfer From Zanzibar Airport To Royal Zanzibar Beach
                Resort: <br />
                <span class="travel-time"> 1 hour 20 minutes</span><br />
                Distance: <span class="travel-time">65 km</span> <br />
              </p>
            </div>
            <div class="way">
              ...
              <p>
                ...
                the Zanzibar islands. Located on the northernmost tip, it is an
                outstanding beach vacation spot offering you fantastic options
                for water sports, restaurants, and nightlife.
              </p>
              <p>
            ...
            <div class="way">
              ...
              <h3>Royal Zanzibar Beach Resort - Stone Town</h3>
              <p>
                Your driver reports to the hotel for a road transfer to Stone
                Town. On the route, you will visit the spice plantations for a
                tour that will awaken your senses. On the spice tour, you can
                pick, smell and savor the spices and fruits you have probably
                never seen on the supermarket shelf. You can observe closely how
                local farmers produce some of the world’s most exotic spices and
                fruits like cloves, star fruit, lemon grass, mangosteen,
                lipstick trees and many more, depending on the season.
              </p>
              <p>
                ...
                Zanzibar, adorned with fresh vegetables and the smell of
                tropical fruits.
              </p>
              <p>
        ...
        <div class="det-down">
          <div class="inclusion">
            ...
            <ul>
              <li>
                3 nights’ accommodation at Royal Zanzibar Beach Resort on an
                all-inclusive basis and 1 night at the Tembo Hotel in Stone Town
                on bed-and-breakfast based on 2 people sharing
              </li>
