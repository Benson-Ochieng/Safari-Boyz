...
<section class="pages-hero package-det">
      <div class="home-page-slider">
        <img src="<?php bloginfo('template_directory');?>/images//essque.jpeg" alt="essque" class="home-page-img" />
        <img
      ...
      <div class="container flex flex-cl">
        <h1>essque zalu and park hyatt</h1>
    ...
    <section class="details" id="details">
      ...
      <div class="container">
        <h2>ITINERARY</h2>
        <p class="det-top-p">
          Enjoy an excellent 5-night, 6-day Zanzibar package with accommodation
          at the stunning Essque Zalu Zanzibar offering you the ultimate luxury
          with a real feeling of the place and the Park Hyatt hotel that sits
          majestically on the beachfront in the heart of Stone Town. This tour
          starts with pick-up and ends with drop-off at the Abeid Amani Karume
        ...
        <div class="itinerary">
          <div class="itinerary-content">
            <div class="way">
              ...
              <h3>
                Abeid Amani Karume International Airport - Essque Zalu Zanzibar
              </h3>
              <p>
                Your driver reports at Abeid Amani Karume International Airport
                for pick-up and road transfer to Essque Zalu Zanzibar hotel.
                Enjoy the drive across the beautiful island on your way to the
                hotel. Check-in at the hotel for an overnight stay.
              </p>
              <p>
                Essque Zalu Zanzibar is an intimate boutique destination lodged
                in a natural cove on the northeast coast of Zanzibar, having
                turquoise waters of the Indian Ocean to one side and lush green
                forest to the other, with a hint of spice on the warm and
                fragrant tropical air. Essque Zalu Zanzibar lets you experience
                luxury in your personal paradise.
              </p>
              <p>
                Road Transfer From Zanzibar Airport To Essque Zalu Zanzibar:
                <span class="travel-time">1 hour 20 minutes</span>
                <br />
                Distance: <span class="travel-time">64 km</span>
              </p>
            </div>
            <div class="way">
            ...
            <div class="way">
              ...
              <h3>Essque Zalu Zanzibar - Stone Town</h3>
              <p>
                Your driver reports to the Essque Zalu Zanzibar Hotel for a road
              ...
              <p>
                After your Stone Town tour, check in at the Park Hyatt hotel for
                an overnight stay.
              </p>
            ...
            <div class="way">
              ...
              <p>
                ...
                island is the colony of giant tortoises.
              </p>
              <p>
                Learn more about the island’s history as you explore its ancient
                prison buildings, meet giant tortoises at the island sanctuary,
                and get a glance under the calm waters while swimming and
                snorkeling around the island’s coral reefs.
              </p>
              <p>
                After the Prison Island tour, a road transfer back to the Park
                Hyatt hotel where you can spend the afternoon at your leisure.
                Overnight stay at the hotel.
              </p>
            </div>
            <div class="way">
              <span class="day">day 6</span>
              <h3>Park Hyatt - Abeid Amani Karume International Airport</h3>
              <p>
                Have breakfast and check out from the Park Hyatt hotel. Your
        ...
        <div class="det-down">
          <div class="inclusion">
            ...
            <ul>
              <li>
                3 nights’ accommodation at Essque Zalu Zanzibar on a full-board
                basis and 2 Nights at Park Hyatt in standard double rooms on
                bed-and-breakfast based on 2 people sharing
              </li>
